    ...
    return (
      <div className="bg-[#f8f7f4] rounded-xl p-8">
        <div className="flex items-center mb-8">
          ...
          <h2 className="text-2xl font-normal text-[#010101]">Notifications Admin</h2>
        </div>
      ...
      <div className="bg-white rounded-lg overflow-hidden">
        <div className="max-h-96 overflow-y-auto">
          {unreadNotifications.slice(0, 20).map((notification) => (
            <div key={notification.id} className="p-6 border-b border-gray-100 hover:bg-gray-50 transition-colors">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-[#0a3d3f] rounded-full mt-2 flex-shrink-0"></div>
                    <div className="flex-1">
                      <p className="text-sm font-medium text-[#010101] mb-2">{notification.description}</p>
                      {notification.user && (
                ...
                >
                  ...
                  {markingAsRead === notification.id ? "..." : 'Marqué comme "lu"'}
                </button>
              </div>
            </div>
          ))}
