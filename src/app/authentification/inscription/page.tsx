    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-40">
        <div className="mb-12">
          ...
          <p className="text-gray-600">Crée ton compte GRINDCYCLE et rejoins notre communauté</p>
        </div>
          ...
          <div className="space-y-8">
            <div className="bg-[#f8f7f4] rounded-xl p-8 ">
              ...
              <p className="text-gray-600 text-sm mt-6">
                ...
                <Link href="/authentification/connexion" className="text-[#0a3d3f] hover:underline font-medium">
                  Se connecter
                </Link>
              </p>
            </div>
