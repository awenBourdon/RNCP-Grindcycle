...
export const Hero = () => {
  return (
    <section
      className="relative py-12 md:py-20 w-full bg-[#f8f7f4] text-[#010101] overflow-hidden"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 py-12 md:py-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Link
                ...
                aria-label="Accéder au catalogue des planches"
              >
              ...
              <Link
                ...
                aria-label="En savoir plus sur Grindcycle"
              >
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative w-full aspect-[6/5] rounded-xl overflow-hidden border-4 border-white shadow-xl">
              <Image
                src="/hero.webp"
                alt="Planche de skate recyclée - image héro"
                fill
