  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-40">
        ...
        <div className="bg-[#f8f7f4] rounded-xl p-8 mb-8 border border-gray-200">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="flex items-center space-x-6">
              ...
              <div>
                <h1 className="text-3xl font-normal text-black mb-2">Bonjour, {session.user.name || "Utilisateur"}</h1>
                ...
                <div className="flex items-center justify-between p-4 bg-white rounded-lg">
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-medium ${
                      FULL_POST_ACCESS.success ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                    }`}
                  >
            ...
            <div className="bg-[#f8f7f4] rounded-xl p-8 border border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-medium">{new Date(session.user.createdAt).toLocaleDateString("fr-FR")}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 bg-[#f8f7f4] rounded-xl p-6 border border-gray-200">
