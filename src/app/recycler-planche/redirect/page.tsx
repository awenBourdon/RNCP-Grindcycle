    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-40">
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-[#f8f7f4] rounded-xl p-8 mb-12">
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-600">Suivre le statut de tes planches recyclées</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[#0a3d3f] rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[#0a3d3f] rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-gray-600">Accéder à ton historique de recyclage</p>
              </div>
            </div>
          </div>
          ...
          <p className="text-gray-500 text-sm mt-8">Déjà membre ? La connexion ne prend que quelques secondes.</p>
        </div>
      </div>
    </div>
  )
