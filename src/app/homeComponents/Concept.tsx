  ...
  <div className="max-w-7xl mx-auto px-6">
    <div className="mb-16">
      ...
      <p className="text-lg text-gray-600 max-w-3xl">
        Découvre les étapes simples pour acheter ou échanger tes planches de skate pour qu&apos;elles se fassent recycler.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-32 items-center">
        ...
        <div className="space-y-8">
          <div className="flex items-start gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">Parcours notre collection de modèles uniques et recyclés</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">Livraison rapide et satisfaction garantie</p>
            </div>
          </div>
        </div>
      ...
      <div className="relative">
        ...
        <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-lg max-w-[250px] shadow-lg">
          ...
          <p className="text-sm text-gray-600">Plusieurs options de paiement disponibles</p>
        </div>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
      <div className="order-2 lg:order-1 relative">
        ...
        <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-lg max-w-[250px] shadow-lg">
          ...
          <p className="text-sm text-gray-600">À partir de 100€ d&apos;achat</p>
        </div>
      </div>
      ...
      <div className="order-1 lg:order-2 space-y-12">
        ...
        <h3 className="text-3xl font-normal">Donne une seconde vie à ta planche</h3>
        ...
        <div className="space-y-8">
          <div className="flex items-start gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">On te la récupère gratuitement</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">On la réhabilite pour lui donner une seconde vie</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">Dès l&lsquo;échange et encore plus lors de la revente</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">Contre une planche recyclée et va rouler !</p>
            </div>
          </div>
        </div>
