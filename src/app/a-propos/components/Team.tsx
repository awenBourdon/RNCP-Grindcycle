    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      <div>
        <div className="relative aspect-square mb-4 overflow-hidden rounded-xl bg-gray-500">
          <Image src="/placeholder.svg?height=400&width=400" alt="Alex Dupont" fill className="object-cover" />
        </div>
      ...
      <div>
        <div className="relative aspect-square mb-4 overflow-hidden rounded-xl bg-gray-500">
          <Image src="/placeholder.svg?height=400&width=400" alt="Marie Leroy" fill className="object-cover" />
        </div>
      ...
      <div>
        <div className="relative aspect-square mb-4 overflow-hidden rounded-xl bg-gray-500">
          <Image src="/placeholder.svg?height=400&width=400" alt="Thomas Martin" fill className="object-cover" />
        </div>
      ...
      <div>
        <div className="relative aspect-square mb-4 overflow-hidden rounded-xl bg-gray-500">
          <Image src="/placeholder.svg?height=400&width=400" alt="Julie Moreau" fill className="object-cover" />
        </div>
