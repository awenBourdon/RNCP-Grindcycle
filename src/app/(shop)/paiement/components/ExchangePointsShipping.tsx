...
export function ExchangePointsShipping({
  ...
  return (
    <div
      ...
      aria-label="Page d'échange de points"
    >
        ...
        <div className="flex items-center mb-8">
          <div>
            ...
            <p
              ...
              aria-label={`Utilisation de ${totalPoints} points pour l'échange, livraison offerte`}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2">
            <ShippingForm
              ...
              aria-label={`Formulaire d'échange de ${totalPoints} points`}
            />
          </div>

          <div>
            <div
              className="bg-[#f8f7f4] p-6 rounded-xl sticky top-40"
            ...
            >
              ...
              <div
                ...
                aria-label="Liste des articles à échanger"
              >
                {cartItems.map(item => (
                  <div
                    key={item.id}
                    className="flex justify-between items-center"
                    aria-label={`Article : ${item.name}, ${item.pricePoints} points`}
                  >
                    <div>
                ...
                <div
                  className="border-t border-gray-200 pt-4 flex justify-between font-medium text-lg"
                  aria-label={`Total : ${totalPoints} points`}
                >
                  <span>Total</span>
              ...
              <div
                ...
                aria-label={`Solde après échange : ${userPoints - totalPoints} points`}
              >
