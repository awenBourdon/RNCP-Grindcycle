...
export const Concept = () => {
  return (
    <section
      className="py-24 bg-[#f8f7f4] text-[#010101]"
      aria-label="Comment fonctionne Grindcycle"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-32 items-center">
          <div className="space-y-12">
            <div
              className="inline-flex items-center space-x-2 px-4 py-2 bg-[#0a3d3f] text-white rounded-full"
              aria-label="Mode d'achat direct"
            >
            ...
            <div className="space-y-8" role="list">
              <div className="flex items-start gap-6" role="listitem">
                <div
                  className="flex-shrink-0 w-10 h-10 flex items-center justify-center bg-[#0a3d3f] text-white text-xl font-medium rounded-full"
                  aria-hidden="true"
                >
                  1
                </div>
            ...
            <div>
              <Link
                ...
                aria-label="Accéder au catalogue de planches"
              >
          ...
          <div className="relative">
            <div className="relative overflow-hidden aspect-[4/3] rounded-xl">
              <Image
                src="/concept1.webp"
                alt="Achat de planches recyclées - étapes du processus"
                width={800}
                height={600}
            ...
            <div
              className="absolute -bottom-6 -left-6 bg-white p-4 rounded-lg max-w-[250px] shadow-lg"
              aria-label="Information : paiement sécurisé"
            >
              <div className="flex items-center space-x-2 mb-2">
                <div
                  className="w-8 h-8 flex items-center justify-center bg-[#0a3d3f] rounded-full text-white text-sm"
                  aria-hidden="true"
                >
                  €
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="order-2 lg:order-1 relative">
            <div className="relative overflow-hidden aspect-[4/3] rounded-xl">
              <Image
                src="/concept2.webp"
                alt="Recyclage de skate - étapes du processus"
                width={800}
                height={600}
                className="object-cover w-full h-full"
              />
            ...
            <div
              className="absolute -bottom-6 -left-6 bg-white p-4 rounded-lg max-w-[250px] shadow-lg"
              aria-label="Information : expédition gratuite à partir de 100€ d'achat"
            >
              <div className="flex items-center space-x-2 mb-2">
                <div
                  className="w-8 h-8 flex items-center justify-center bg-[#0a3d3f] rounded-full text-white text-sm"
          ...
          <div className="order-1 lg:order-2 space-y-12">
            <div
              className="inline-flex items-center space-x-2 px-4 py-2 bg-[#0a3d3f] text-white rounded-full"
              aria-label="Mode d'échange de planche"
            >
            ...
            <div>
              <Link
                ...
                className="inline-flex items-center group"
                aria-label="Accéder à la page de recyclage de planche"
              >
                <span className="border-b border-black pb-1 group-hover:border-[#0a3d3f] transition-colors">
                  Recycler ma planche
                </span>
