      ...
      <div className="grid md:grid-cols-2 gap-16 items-start">
        ...
        <div>
          ...
          <p className="text-gray-600 text-lg mb-8">
            {product.description || "Planche de skate recyclée, parfaite pour tous les styles de ride."}
          </p>

          <div className="space-y-4 mb-8">
            <div className="flex items-center border-b border-gray-200 pb-3">
              <span className="w-24 font-medium">Type :</span>
              <span className="text-gray-600 capitalize">{product.type || "Skate"}</span>
            </div>
            <div className="flex items-center border-b border-gray-200 pb-3">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mt-8">
            <div className="text-[#0a3d3f]">
              <span className="text-3xl font-normal">{product.priceEuro} €</span>
            </div>
            {product.pricePoints && <span className="text-sm text-gray-600">ou {product.pricePoints} points</span>}
          </div>
